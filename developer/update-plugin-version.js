...
const pluginFilePath = path.join(__dirname, '../obatala.php'); // Caminho para o arquivo principal do plugin
const readmeFilePath = path.join(__dirname, '../README.md'); // Caminho para o arquivo README.md
